...
function LeadsTable({ leads }: { leads: Lead[] }) {
  return (
    <div className="px-4 sm:px-6 md:px-8 lg:px-48 py-8 lg:py-16">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-0">All leads</h1>
        <a
          className="group bg-gray-900 text-white px-5 sm:px-7 py-2 sm:py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition"
          onClick={(e) => {
            e.preventDefault();
      ...
      <div className="overflow-hidden bg-white bg-opacity-0 rounded-lg shadow">
        <div className="overflow-x-auto max-w-full">
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden md:max-w-3xl lg:max-w-full mx-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Serial No.</th>
