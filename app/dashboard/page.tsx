...
function LeadsTable({ leads }: { leads: Lead[] }) {
  return (
    <div className="px-48 py-16 sm:px-6 md:px-8 sm:py-12 md:py-16">
        ...
        <table className="w-full">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {leads.map((lead, index) => (
              <tr key={index}>
                <td className="py-4 px-6 whitespace-nowrap text-gray-950">{lead.name}</td>
                <td className="py-4 px-6 whitespace-nowrap text-gray-950">{lead.email}</td>
                <td className="py-4 px-6 whitespace-nowrap text-gray-950">{lead.source}</td>
